...
#     area_cell.formula = str(float(width))+'*'+str(float(length))
#     cell_list += [pygsheets.Cell((myRow, myCol+1), width),
#                   pygsheets.Cell((myRow, myCol+2), length),
#                   area_cell]
#     print(myCol)
#     print(cell_list)
#
# #    worksheet.cell((myRow, myCol+1)).formula = str(width)+'*'+str(length)+'+'+''+str(5)+'*'+str(6)
#
...
#
# if len(measurements) == 4 or len(measurements) == 2:
